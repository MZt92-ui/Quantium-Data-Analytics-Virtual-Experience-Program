...
Python with corresponding data analysis packages like Pandas will be used for exploratory analysis, and key findings will be presented in right figures using Excel. 
#### Task 2
...
-	Compare trial stores and controls stores performances

Python will be used for statistical analysis, and key findings will be presented in right figures using Excel. 
...
The package size has been divided into the following 5 categories: mini: 0-100g small: 100-200g medium: 200-300g large: 300-350g Jumbo: over 350g All customer segments behave similarly in terms of package size, with small (100-200g) size outstandingly accepted.
